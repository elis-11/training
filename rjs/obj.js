const arr = [
    ...
    {_id: "p2",status: "1",name: "Mango",volume: 8,category: "fruit", price: 1.7,inside: true,},
    ...
    {_id: "p5",status: "1",name: "Mango",volume: 8,category: "fruit", price: 1.7,inside: true,},
  ...
  console.log('countPrice', countPrice.toFixed(0))
